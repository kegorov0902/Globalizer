...
\brief Объявление класса #Method RSA

\details Объявление класса #Method RSA и сопутствующих типов данных
*/


#ifndef __METHOD_RSA_H__
#define __METHOD_RSA_H__
...
/**
Базовый класс, реализующий алгоритм поиска нуля (корня).

В классе #Method_RSA реализованы основные функции, определяющие работу алгоритма поиска нуля (корня).
*/
class Method_RSA : public IMethod
{
protected:
    // ----------------------------------------------------------------------------
